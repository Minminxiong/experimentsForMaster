...
#    print(tf.train.GradientDescentOptimizer(learning_rate))  
    ...
    #        print('训练数据量为：',sess.run(x))      
        ...
        for i in range(training_steps):  
            ...
            if i%1000==0:  
                #将模型保存到这个文件下  
                save_path = saver.save(sess, 'my_net_Dropout/DNN_model.ckpt')  
...
def main(args):
    train_data = read_features_csv(args.input_trainFile, args.My_Model)
    test_data = read_features_csv(args.input_testFile, args.My_Model)
